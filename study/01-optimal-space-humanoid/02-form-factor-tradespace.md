...
The Lunokhod counterargument must be engaged directly. Lunokhod 1 and Lunokhod 2 together traversed approximately 50 km of lunar surface (Lunokhod 1: 10.5 km over 11 months; Lunokhod 2: 39.2 km per LRO photogrammetric cartographic revision \cite{huntress2011soviet}; the 39.2 km figure supersedes the original ~37 km estimate and is based on LROC NAC high-resolution imagery) and returned more scientific data per kilogram of delivered hardware than any other robotic lunar mission. The Soviet engineers built a rover optimized for the lunar surface — eight independently-driven wheels, rocker-bogey suspension, pressurized electronics compartment, lid-mounted solar array — and it worked. The lesson drawn by Soviet and post-Soviet designers is that purpose-built beats generalist in resource-constrained environments. FEDOR itself was the Soviet attempt to apply the same philosophy to a humanoid: build a capable teleop avatar, don't try to generalize.
...
\cite{huntress2011soviet} — Lunokhod 1/2 traverse and scientific return; Soviet purpose-built design philosophy. Note: the 39.2 km Lunokhod 2 figure supersedes the ~37 km estimate in Huntress & Marov (2011) and derives from LRO photogrammetric cartographic revision (LROC NAC high-resolution imagery, post-2010); Huntress & Marov is cited for the Lunokhod design philosophy and Lunokhod 1 traverse distance.
