...
**Artifact:** `study/04-build-and-deploy/01-technology-roadmap.md`
...
3. **Long-poles.** Likely candidates: humanoid autonomy in unstructured environments, dust-tolerant joint sealing, fission surface power deployment, far side relay infrastructure, lunar-night humanoid survival. Detail the development path for the top 5.
4. **Demonstrations.** Each TRL advance needs a demonstration. ISS humanoid demos, lunar near-side precursor missions, Earth analog campaigns (Antarctic, lava tubes, JPL Mars Yard). Sequence them on a timeline.
