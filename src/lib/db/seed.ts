  ...
  const recs = [
    {
      ...
      factor_scores: JSON.stringify({ technical: { score: 8.0, inputs: ["50-day MA above 200-day", "RSI 58"], reasoning: "Bullish trend" }, fundamental: { score: 8.5, inputs: ["P/E below sector avg"], reasoning: "Solid fundamentals" }, sentiment: { score: 7.5, inputs: ["18/24 Buy"], reasoning: "Strong consensus" }, momentum: { score: 8.5, inputs: ["+5% 1M"], reasoning: "Outperforming" }, earnings: { score: 8.5, inputs: ["4/4 beats"], reasoning: "Consistent" }, governance: { score: 8.0, inputs: ["Stable board", "Tim Cook tenure"], reasoning: "Strong leadership continuity" }, macro: { score: 7.0, inputs: ["Rate sensitivity low", "Strong pricing power"], reasoning: "Well-positioned in current cycle" } }),
    ...
    },
    {
      ...
      factor_scores: JSON.stringify({ technical: { score: 7.0, inputs: ["Consolidating near highs"], reasoning: "Neutral trend" }, fundamental: { score: 8.0, inputs: ["Fair P/E for growth"], reasoning: "Well-valued" }, sentiment: { score: 7.5, inputs: ["20/26 Buy"], reasoning: "Bullish" }, momentum: { score: 7.0, inputs: ["+3% 1M"], reasoning: "In-line" }, earnings: { score: 8.0, inputs: ["Consistent beats"], reasoning: "Reliable" }, governance: { score: 8.5, inputs: ["Satya Nadella strong tenure", "Stable board"], reasoning: "Excellent leadership track record" }, macro: { score: 7.5, inputs: ["Cloud spending resilient", "Enterprise demand stable"], reasoning: "Defensive growth in tight monetary policy" } }),
      factor_details: JSON.stringify({}),
    ...
    },
    {
      ...
      factor_scores: JSON.stringify({ technical: { score: 7.5, inputs: ["Breaking out of range"], reasoning: "Bullish setup" }, fundamental: { score: 7.0, inputs: ["P/E reasonable for growth"], reasoning: "Fair value" }, sentiment: { score: 7.5, inputs: ["20/28 Buy"], reasoning: "Bullish consensus" }, momentum: { score: 7.0, inputs: ["+4% 1M"], reasoning: "Positive" }, earnings: { score: 7.0, inputs: ["Beat last 3/4"], reasoning: "Mostly reliable" }, governance: { score: 7.5, inputs: ["Andy Jassy settling in", "Board experienced"], reasoning: "Stable leadership after transition" }, macro: { score: 7.0, inputs: ["Consumer spending mixed", "AWS resilient"], reasoning: "Retail sensitive but cloud offsets" } }),
      factor_details: JSON.stringify({}),
