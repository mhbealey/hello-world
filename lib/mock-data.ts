...
export const MOCK_RISKS: RiskWithActions[] = [
  { id: "r0", org_id: "mock-org", name: "Exit Value Erosion", ale_cents: 1_980_000_000, plain_english: "Without proper cyber governance at portfolio companies, exit valuations could be reduced by $15-25M due to unaddressed security gaps discovered during buyer due diligence.", recommended_response: "Implement comprehensive cyber governance framework across all portfolio companies before exit preparation begins.", sort_order: 0, created_at: "", linked_action_ids: ["a1"], addressed: false, days_since_update: 3 },
  { id: "r1", org_id: "mock-org", name: "Data Breach", ale_cents: 680_000_000, plain_english: "A data breach at any portfolio company could result in regulatory fines, legal costs, and reputational damage averaging $6.8M per incident.", recommended_response: "Deploy continuous monitoring and ensure all portfolio companies maintain current incident response plans.", sort_order: 1, created_at: "", linked_action_ids: ["a0", "a4"], addressed: false, days_since_update: 3 },
  { id: "r2", org_id: "mock-org", name: "AI Exposure", ale_cents: 650_000_000, plain_english: "Unmonitored AI tool usage across portfolio companies creates data leakage risk, regulatory exposure, and potential IP compromise.", recommended_response: "Establish AI governance policy and deploy monitoring tools across the portfolio.", sort_order: 2, created_at: "", linked_action_ids: ["a1"], addressed: false, days_since_update: 15 },
  { id: "r3", org_id: "mock-org", name: "SEC Enforcement", ale_cents: 580_000_000, plain_english: "SEC cybersecurity disclosure rules require documented governance. Non-compliance risks enforcement actions and LP confidence erosion.", recommended_response: "Close open audit findings and ensure all required documentation is current.", sort_order: 3, created_at: "", linked_action_ids: ["a0"], addressed: false, days_since_update: 15 },
  { id: "r4", org_id: "mock-org", name: "Vendor Compromise", ale_cents: 420_000_000, plain_english: "Third-party vendor breaches can cascade across portfolio companies sharing common service providers.", recommended_response: "Deploy AI-powered vendor monitoring and establish third-party risk management program.", sort_order: 4, created_at: "", linked_action_ids: ["a4"], addressed: false, days_since_update: 45 },
  { id: "r5", org_id: "mock-org", name: "Ransomware", ale_cents: 370_000_000, plain_english: "Ransomware attacks can halt portfolio company operations for weeks, destroying value and triggering insurance claims.", recommended_response: "Implement business continuity and disaster recovery testing program across the portfolio.", sort_order: 5, created_at: "", linked_action_ids: ["a3"], addressed: false, days_since_update: 3 },
];
